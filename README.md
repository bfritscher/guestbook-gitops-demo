...
```
1. 🌐 User visits https://gb-bf.duckdns.org/
...
- DNS record pointing `gb-bf.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/bfritscher/guestbook-gitops-demo
   ```
